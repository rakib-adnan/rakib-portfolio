...
import {
  FaWordpress, FaReact, FaShopify, FaJs, FaArrowRight,
  FaEnvelope, FaDownload, FaGithub, FaLinkedin, FaWhatsapp,
} from 'react-icons/fa'
import { SiReact as SiReactnative } from 'react-icons/si'
import { HiCode, HiSparkles } from 'react-icons/hi'
import { useGetSiteSettingsQuery } from '../../services/portfolioApi'
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{name} | Professional Web Developer</title>
        <meta name="description" content={`${name} - Professional Web Developer specializing in WordPress, Shopify, React JS, and React Native. 5+ years, 500+ projects.`} />
        <meta property="og:title" content={`${name} | Professional Web Developer`} />
      ...
      {/* ── HERO ── */}
      <section className="relative z-10 min-h-screen" style={{ backgroundColor: '#030712' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20 pb-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1">
                ...
                >
                  Hi, I&apos;m{' '}
                  <span className="text-gradient animate-glow">{name}</span>
                </motion.h1>
                ...
                >
                  {socialLinks.map(({ icon: Icon, href, label }) => (
                    <a
                      ...
                      aria-label={label}
                      className="w-10 h-10 rounded-xl bg-dark-800/70 border border-white/5 hover:border-cyan-500/30 flex items-center justify-center text-slate-400 hover:text-cyan-400 transition-all"
                    >
                      <Icon size={17} />
                    </a>
                  ))}
                        ...
                        <div className="w-full h-full rounded-full bg-gradient-to-br from-dark-700 to-dark-800 flex items-center justify-center overflow-hidden">
                          {profileImage ? (
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-cyan-400 text-sm font-semibold">{name}</p>
